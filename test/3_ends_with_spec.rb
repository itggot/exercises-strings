...
describe "#{FUNCTION}" do
    ...
    it 'returns correct value' do
        assert_equal false, send(FUNCTION.to_sym, "omgomgomg", "o")
    end
    
    it 'returns correct value for non-alpha' do
        assert_equal true, send(FUNCTION.to_sym, "This is some text!", "!")
    end
    ...
    it 'returns correct value for random gibberish' do
        100.times do 
            ...
            assert_equal gibberish.end_with?(char), send(FUNCTION.to_sym, gibberish, char)
        end
    end
end